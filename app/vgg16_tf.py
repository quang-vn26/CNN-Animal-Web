...
def test_single_image(path):
    ...
    model = keras.models.load_model('module/model_vgg_2.h5',  custom_objects={'LeakyReLU': keras.layers.LeakyReLU})
    ...
    return animals[class_predicted[0]],score

if __name__ == '__main__':
    print('Begin Testing: ')
    result,score = test_single_image(path_img)
    print(result,score)
